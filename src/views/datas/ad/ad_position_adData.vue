    ...
    data() {
		return{
			searchConfig:{
				...
				api:'data_ad_ad_space',
				url:'/#/data/ad_position_ads?',
				pr:[{k:'ad_space_id',v:'ad_space_id'},{k:'times',v:'create_time'}],
				data_type:'ad_space_id',
				getUc:'ad_space_type',
			},
			tableConfig:[
	...
	methods: {
		backData(da){
			return {
				...
				ad_space_id:da.ad_space_id,	
				ad_space_name:da.ad_space_name,													
				channel:da.channel,
				product:da.product,
				ad_space_type:da.ad_space_type,
				pv:+da.pv,
				click:+da.click,
				click_ratio:da.click_ratio,
