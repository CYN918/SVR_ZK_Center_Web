...
export default {
	...
	methods: {
		...
		seeXx2(on){
			window.open('/#/data/ad_material_ms?template_id='+this.tableData[on].template_id)
		...
		getData(sxtj){
			...
			this.api.data_ad_material_template({params}).then((datas)=>{									
