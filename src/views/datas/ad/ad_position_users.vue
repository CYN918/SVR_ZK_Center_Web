    ...
    data() {
		return{
			searchConfig:{
				...
				api:'data_ad_master_detail',
				url:'',
				pr:[{k:'admaster',v:'admaster'},{k:'times',v:'create_time'}],
				getUc:'admaster',				
			},
			tableConfig:[
	...
	methods: {
		backData(da){
			return {
				...
				admaster:da.admaster,
				work_type_name:da.work_type_name,						
				ad_id:da.ad_id,
				ad_name:da.ad_name,
				ad_space_id:da.work_type,
				ad_space_type:da.work_type,
				product:da.product,
				pv:+da.pv,
				click:+da.click,
