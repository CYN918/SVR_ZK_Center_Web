            ...
            <div class="themeUpLeft">
                ...
                <div>
                    ...
                    <div  v-if="thmid!=undefined&&this.type!='th_advertise'">
                        ...
                        <span class="sm2">绑定制作{{this.type=='th_lock_screen'?'锁屏':this.type=='th_icon'?'图标':this.type=='theme_two'?'二级页':'宣传图'}}的相关作品，千万不要填错了</span>
                    </div>
                    <div v-if="thmid==undefined&&this.type!='th_advertise'">
                        <span>绑定设计师素材</span>
                ...
                <div v-if="this.type!='th_advertise'">
                    ...
                    <span class="sm2">绑定制作{{this.type=='th_lock_screen'?'锁屏':this.type=='th_icon'?'图标':this.type=='theme_two'?'二级页':'宣传图'}}的相关主题素材，千万不要填错了</span>
                    <div class="img_box">
