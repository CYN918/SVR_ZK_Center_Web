				...
				<div class="boxImg_right" >
					<div class="boxImg_right_1">
						...
						<div>
							...
							<span class="boxImg_content" v-if="(DL.attach.size/1024/1024/1024).toFixed(2)>=1">{{(DL.attach.size/1024/1024/1024).toFixed(2)}}GB</span>a class="dowload" :href="DL.attach.url">下载</a>
						</div>
					</div>
				</div>
