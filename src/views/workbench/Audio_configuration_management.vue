            ...
            <div class='details' v-if="mfinal">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <a v-if="mfinal.attach" :href="mfinal.attach.url" style="color:#3377ff;cursor: pointe;margin-left:10px">下载</a>
                </div>
            </div>
        </div>
        <ADDWL v-if="ADDwl" @listenToChildEvent="listenToChildEvent" :video='video' :pro_type="pro_type"></ADDWL>
