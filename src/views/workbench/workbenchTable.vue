                ...
                <el-table
                    ...
                    <el-table-column label="操作"> 
                        <template slot-scope="props">
                            ...
                            <el-button @click='push(tableData[props.$index].did,tableData[props.$index].status)' v-if="tableData[props.$index].status_name=='确认入库'&&tableData[props.$index].isfinish!=2" >
                                入库确认
                            </el-button>
