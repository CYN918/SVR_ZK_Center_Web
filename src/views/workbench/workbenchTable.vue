                            ...
                            <div>
                                <div class="step_box" v-for="(item,index) in tableData[props.$index].audit_process">
                                    ...
                                    <div class="step_contnet" v-if="item.creator!=''||tableData[props.$index].status==item.status">
                                        ...
                                        <span class="dj" @click="check(tableData[props.$index].demand_type,tableData[props.$index].did,tableData[props.$index].status+1,tableData[props.$index].reject)"  v-if="item.reject=='1'&&tableData[props.$index].status!=item.status">查看驳回原因</span>
