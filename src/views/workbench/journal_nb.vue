        ...
        <el-dialog
            ...
            <el-form label-width="120px">
                ...
                <el-form-item label="标题:" v-if="click_action != '-1'&&click_action != '3'">
                    <el-input type="text" maxlength="20"  placeholder="最多20字" show-word-limit v-model="title"></el-input>
                </el-form-item>
                <el-form-item label="内容描述:" v-if="click_action != '-1'&&click_action != '3'">
                    <el-input type="textarea" maxlength="200"  placeholder="最多200字" show-word-limit  v-model="content"></el-input>
                </el-form-item>
