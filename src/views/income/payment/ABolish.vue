    ...
    <div class="bg" @click="heid">
        <div class="content" @click.stop>
            <div class="tit">
                ...
                <span v-if="list.length!=0">查看废除原因</span>
                <img src="../../../../public/img/gb.png" @click="heid"/>
            </div>
            <div class="tishi">
                <textarea placeholder="请输入废除原因" v-model="note" maxlength="20" v-if="list.length==0"></textarea>
                <textarea placeholder="请输入废除原因" v-model="note" maxlength="20" v-if="list.length!=0" disabled></textarea>
            </div>
            <div class="btn">
